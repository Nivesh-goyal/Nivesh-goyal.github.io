...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4362fc6a7ac7eaed9b44018f5e3e25df3412f31090068f432d5b0af0cbb98b22.js',function(){input.required=false;search();});}
